...
* **[Deployment Guide](file:///Users/v1/My%20Projects%202025/Code/ai-gateway-tco-dashboard/DEPLOYMENT.md)**: Step-by-step instructions on deploying the gateway backend on Azure Container Apps (or Render) and the frontend dashboard on Azure Static Web Apps (or Vercel).
